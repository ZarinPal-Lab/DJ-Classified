...
//		];
//
//		$redirect = "index.php?option=com_djclassifieds";
//		$item_cid = '';
//		$item_id = $row_context['item_id'];
//
//		switch($type)
//		{
//			case 'prom_type':
...
//				$item = $db->loadObject();
//				if(!isset($item)){
//					$app->redirect($redirect . "&view=items&cid=0");
//					exit;
//				}
//
//				$row_context['price'] = $par->get('promotion_move_top_price',0);
//				$row_context['type'] = 2;
//
//				$amount = $par->get('promotion_move_top_price',0);
//				$itemname = $item->name;
...
//				$points = $db->loadObject();
//				if(!isset($points)){
//					$app->redirect($redirect . "&view=points");
//					exit;
//				}
//
//				$row_context['price'] = $points->price;
//				$row_context['type'] = 1;
//
//				$amount = $points->price;
//				$itemname = $points->name;
...
//				$plan = $db->loadObject();
//				if(!isset($plan)){
//					$app->redirect($redirect . "&view=plans");
//					exit;
//				}
//
//				$row_context['price'] = $plan->price;
//				$row_context['type'] = 3;
//
//				$amount = $plan->price;
//				$itemname = $plan->name;
...
//		}
//
//		foreach ($row_context as $key => $value) {
//			$row->{$key} = $value;
//		}
//
//		$row->store();
 ...
 */
	function _notify_url()
	{
		...
		$app = JFactory::getApplication();
		$input = $app->input;
//		$messageUrl = JRoute::_('index.php?option=com_djclassifieds&view=useritems', false);
